...
--
-- Host: std-mysql    Database: std_2389_exam
-- ------------------------------------------------------
...
CREATE TABLE `books` (
  ...
  `cover_image_id` varchar(100) NOT NULL,
  `created_at` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_books_cover_image_id_images` (`cover_image_id`),
...
-- Dump completed on 2024-06-18  2:10:22